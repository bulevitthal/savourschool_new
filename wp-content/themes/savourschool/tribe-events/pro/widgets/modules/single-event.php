...
<div class="tribe-mini-calendar-event event-<?php esc_attr_e( $mini_cal_event_atts['current_post'] ); ?> <?php esc_attr_e( $mini_cal_event_atts['class'] ); ?>">
	...
	<div class="list-date">
		...
		<span class="list-month"><?php echo apply_filters( 'tribe-mini_helper_tribe_events_ajax_list_daynumber', date_i18n( 'M', $post_date ), $post_date, $mini_cal_event_atts['class'] ); ?></span>
	</div>
	...
	<div class="list-info">
		...
		<h2 class="tribe-events-title">
			...
			<span class="events-title-bg-color">&nbsp;</span>
		</h2>
