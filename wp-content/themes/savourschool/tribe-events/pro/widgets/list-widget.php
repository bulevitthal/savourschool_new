...
if ( isset( $posts ) && $posts ) :
	...
	<p class="tribe-events-widget-link">
		<a href="<?php esc_attr_e( esc_url( $link_to_all ) ) ?>" rel="bookmark" class="upcoming-booking-links">
			<?php echo 'View Class Calendar <i class="fa fa-caret-right" aria-hidden="true"></i>'; ?>
		</a>
	</p>
